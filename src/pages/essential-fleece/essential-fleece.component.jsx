...
import { TreyfoilContainer } from './essential-fleece.styles';
...
const EssentialFleecePage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              ...
              <div className='right-side'>
                <div className='title'>
                  <h2 className='burgundy'>womens nike sportswear heritage joggers</h2>
  ...
  export default connect(mapStateToProps)(EssentialFleecePage);