...
import { TreyfoilContainer } from './champion-life.styles';
...
const ChampionLifePage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 18).map(({id, imageUrl}) => (
  ...
  export default connect(mapStateToProps)(ChampionLifePage);