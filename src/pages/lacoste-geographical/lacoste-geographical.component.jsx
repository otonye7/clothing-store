...
import { TreyfoilContainer } from './lacoste-geographical.styles';
...
const LacosteGeographicalPage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 13).map((section) => (
  ...
  export default connect(mapStateToProps)(LacosteGeographicalPage);