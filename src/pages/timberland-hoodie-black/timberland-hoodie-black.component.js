...
import { TreyfoilContainer } from './timberland-hoodie-black.styles';
...
const TimberlandBlacPage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 11).map(({id, imageUrl, title, description, price}) => (
  ...
  export default connect(mapStateToProps)(TimberlandBlacPage);