...
import { TreyfoilContainer } from './new-balance-phantom.styles';
...
const NewBalancePhantomPage = ({sections}) => {

      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 2).map(({id, imageUrl, title, description, price}) => (
  ...
  export default connect(mapStateToProps)(NewBalancePhantomPage);