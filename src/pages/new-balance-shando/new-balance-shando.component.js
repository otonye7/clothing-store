...
import { TreyfoilContainer } from './new-balance-shando.styles';
...
const NewBalanceShandoPage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 12).map(({id, imageUrl, title, description, price}) => (
  ...
  export default connect(mapStateToProps)(NewBalanceShandoPage);