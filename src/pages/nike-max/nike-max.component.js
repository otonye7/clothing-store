...
import { TreyfoilContainer } from './nike-max.styles';
...
const NikeMaxPage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 17).map(({id, imageUrl, title, description, price}) => (
  ...
  export default connect(mapStateToProps)(NikeMaxPage);