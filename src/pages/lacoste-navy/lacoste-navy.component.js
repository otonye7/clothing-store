...
import { TreyfoilContainer } from './lacoste-navy.styles';
...
const LacosteNavyPage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 14).map(({id, imageUrl, title, description, price}) => (
  ...
  export default connect(mapStateToProps)(LacosteNavyPage);