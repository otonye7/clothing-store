...
import { TreyfoilContainer } from './trefoil-white.styles';
...
const TreyfoilWhitePage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 3).map(({id, imageUrl}) => (
              ...
              <div className='right-side'>
                <div className='title'>
                  <h2 className='burgundy'>Men's adidas Essentials Trefoil Hoodie White Five</h2>
  ...
  export default connect(mapStateToProps)(TreyfoilWhitePage);