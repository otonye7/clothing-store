...
import { TreyfoilContainer } from './bugaboo-ninety.styles';
...
const BugabooNinetyPage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 7).map(({id, imageUrl, title, description, price}) => (
  ...
  export default connect(mapStateToProps)(BugabooNinetyPage);