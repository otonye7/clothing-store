...
import { TreyfoilContainer } from './timberland-tree-black.styles';
...
const TimberlandBlackPage = ({sections}) => {
      ...
      return ( 
           <TreyfoilContainer>
              <div className='left-side'>
                  {
                    sections.filter((item, id) => id === 9).map(({id, imageUrl}) => (
              ...
              <div className='right-side'>
                <div className='title'>
                  <h2 className='burgundy'>Men's Timberland Tree Logo Hoodie Black</h2>
  ...
  export default connect(mapStateToProps)(TimberlandBlackPage);