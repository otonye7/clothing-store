...
import { TreyfoilContainer } from './columbia-multicolor.styles';
...
const ColumbiaMultiColorPage = ({sections}) => {
  ...
  export default connect(mapStateToProps)(ColumbiaMultiColorPage);